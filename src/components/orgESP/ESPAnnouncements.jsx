  ...
  >
    ...
    >
      {data.badgeText && (
        ...
        >
          <Typography sx={{ fontSize: '12px', fontWeight: 500, fontFamily: fonts.sans }}>
            {data.badgeText.includes('Scholarship') ? (
              <>
                <span style={{ color: '#fff' }}>New </span>
                <span style={{ color: '#FF8A00', fontWeight: 700 }}>{data.badgeText}</span>
              </>
            ) : data.badgeText}
          </Typography>
        </Box>
    ...
    <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
      <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
        ...
        <Typography sx={{ fontSize: '14px', fontFamily: fonts.sans, color: '#000' }}>
          {data.date}
        </Typography>
      </Box>
