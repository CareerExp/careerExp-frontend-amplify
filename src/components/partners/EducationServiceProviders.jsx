...
import { getExploreEsps } from "../../api/partnersExploreApi";
  ...
  if (!loading && items.length === 0) {
    return (
      <Box sx={{ py: 6, textAlign: "center" }}>
        ...
        >
          No education service providers found. Try adjusting your search or filters.
        </Typography>
      </Box>
    );
  }
...
export default EducationServiceProviders;
