                ...
                <Grid container spacing={4}>
                    ...
                    <Grid item xs={12} md={6}>
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 2 }}>
                            ...
                            <Typography sx={{ fontFamily: fonts.sans, fontWeight: 700, fontSize: '20px', color: '#000' }}>
                                What's Included
                            </Typography>
                        </Box>
                        <Stack spacing={1.5}>
                            {service.whatsIncluded?.map((item, idx) => (
                                <Box key={idx} sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
                                    ...
                                    <Typography sx={{ fontFamily: fonts.sans, fontSize: '15px', color: '#545454' }}>
                                        {item}
                                    </Typography>
                                </Box>
                            ))}
