        ...
        <Box sx={{ p: 4, minHeight: '100%' }}>
            ...
            >
                ...
                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 3 }}>
                    ...
                    {/* Status badge could go here if needed, like in the card */}
                </Box>
                ...
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: '26px' }}>
                    ...
                    >
                        ...
                        >
                            Application Deadline: {formatDate(announcement.liveEndDate)}
                        </Typography>
                        <Typography
                            sx={{
                                fontFamily: fonts.sans,
                        ...
                        >
                            Don't miss this incredible opportunity to pursue your education with substantial financial support!
                        </Typography>
                    </Box>
                </Box>
            </Paper>
